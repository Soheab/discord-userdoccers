...
| user_id                          | snowflake                                                                          | The ID of the user the subscription belongs to                                                                        |
...
| pause_ends_at                    | ?ISO8601 timestamp                                                                 | When the subscription pause ends                                                                                      |
| pause_reason                     | ?string                                                                            | The reason the subscription is paused                                                                                 |
...
| ended_at?                          | ISO8601 timestamp | When the subscription ended                                                                                                                       |
